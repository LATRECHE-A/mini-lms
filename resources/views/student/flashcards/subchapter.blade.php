{{-- File: resources/views/student/flashcards/subchapter.blade.php --}}
@extends('layouts.app')

@section('content')
<div class="fade-in max-w-3xl">
    <div class="mb-8">
        <a href="{{ route('student.flashcards.formation', $subchapter->chapter->formation) }}" class="text-sm text-slate-500 hover:text-slate-700 inline-flex items-center gap-1 mb-2">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div class="flex items-center gap-2 flex-shrink-0 flex-wrap">
                ...
                @if($dueCount > 0)
                <a href="{{ route('student.flashcards.study', ['sub_chapter_id' => $subchapter->id]) }}"
    ...
    <div class="bg-white rounded-xl border border-slate-200 p-5 mb-3" x-data="{ editing: false }">
        <div x-show="!editing" class="flex items-start justify-between gap-4">
            ...
            <div class="flex items-center gap-1 flex-shrink-0">
                ...
                <form method="POST" action="{{ route('student.flashcards.destroy', $card) }}" onsubmit="return confirm('Supprimer cette flashcard ?')">
                    @csrf @method('DELETE')
        ...
        <form x-show="editing" x-transition x-cloak method="POST" action="{{ route('student.flashcards.update', $card) }}" class="space-y-3">
            @csrf @method('PUT')
