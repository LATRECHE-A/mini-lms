{{-- resources/views/student/flashcards/formation.blade.php --}}
@extends('layouts.app')
...
<div class="fade-in">
    <div class="mb-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            @if($stats['due'] > 0)
            <a href="{{ route('student.flashcards.study', ['formation_id' => $formation->id]) }}" class="bg-brand-600 hover:bg-brand-700 text-white text-sm font-medium py-2 px-4 rounded-lg transition-colors inline-flex items-center gap-2 flex-shrink-0">
