{{-- File: resources/views/student/chapters/create.blade.php --}}
@extends('layouts.app')
...
<div class="fade-in max-w-2xl">
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-slate-900">Nouveau chapitre</h1>
    </div>

    <div class="bg-white rounded-xl border border-slate-200 p-6">
        <form method="POST" action="{{ route('student.chapters.store', $formation) }}" class="space-y-5">
            @csrf
            <div>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3"
                          class="w-full px-4 py-2.5 rounded-lg border border-slate-300 text-sm focus:ring-2 focus:ring-brand-500 focus:border-brand-500">{{ old('description') }}</textarea>
            </div>
            <div>
