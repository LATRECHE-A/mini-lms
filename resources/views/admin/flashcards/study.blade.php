{{-- resources/views/admin/flashcards/study.blade.php --}}
@extends('layouts.app')
...
function flashcardStudy() {
    return {
        ...
        async rate(quality) {
            ...
            this.loading = true;
            try { await fetch(`{{ url('admin/flashcards') }}/${this.currentCard.id}/review`, { method:'POST', headers:{'Content-Type':'application/json','X-CSRF-TOKEN':document.querySelector('meta[name=csrf-token]').content,'Accept':'application/json'}, body:JSON.stringify({quality}) }); } catch(e) {}
