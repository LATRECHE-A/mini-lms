...
<div class="fade-in max-w-3xl" x-data="aiPlayground()">
    ...
    <form method="POST" action="{{ route('admin.ai.generate') }}" enctype="multipart/form-data"
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <div class="relative">
                    <textarea id="prompt" name="prompt" rows="5" required minlength="10" maxlength="5000"
                        ...
                        placeholder="Ex: Créez un cours complet sur les bases de Python pour débutants...">{{ old('prompt') }}</textarea>
