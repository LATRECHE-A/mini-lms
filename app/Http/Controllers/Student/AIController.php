 ...
 *
 * Controller to handle AI content generation, editing, validation, and import for students.
 * Allows students to create AI-generated content, edit it, and validate it to create formations.
 */
    ...
    public function validate(Request $request, AiGeneration $generation)
    {
        ...
        try {
            $formation = DB::transaction(function () use ($generation) {
                $formation = $this->importer->importForStudent($generation->generated_content, auth()->user());
