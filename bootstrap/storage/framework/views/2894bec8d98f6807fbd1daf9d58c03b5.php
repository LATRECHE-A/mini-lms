...
<head>
    ...
    <title><?php echo e($title ?? 'Mini LMS'); ?> - LMS</title>
...
<body class="h-full bg-slate-50 font-sans text-slate-700 antialiased">
    ...
    <div class="flex h-full min-h-screen" x-data="{ sidebarOpen: false }">
        ...
        <aside class="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:left-0 lg:z-30 bg-slate-900 text-slate-300 shadow-xl">
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                <?php if(auth()->user()->isAdmin()): ?>
                    <?php echo $__env->make('layouts._sidebar_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php else: ?>
                    <?php echo $__env->make('layouts._sidebar_student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endif; ?>
            </nav>
            ...
            <div class="px-4 py-4 border-t border-white/10 flex-shrink-0">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-slate-400"><?php echo e(auth()->user()->role === 'apprenant' ? 'Apprenant' : 'Admin'); ?></p>
                    </div>
        ...
        <main class="flex-1 min-w-0 <?php if(auth()->guard()->check()): ?> lg:ml-64 <?php endif; ?>">
            <?php if(auth()->guard()->check()): ?>
            ...
            <div class="mx-4 mt-4 fade-in" x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)" x-transition>
                <div class="bg-emerald-50 border border-emerald-200 text-emerald-800 px-4 py-3 rounded-lg flex items-center justify-between">
                    <div class="flex items-center gap-2 min-w-0">
                        ...
                        <span class="text-sm truncate"><?php echo e(session('success')); ?></span>
                    </div>
...
<?php /**PATH /home/LTH/Stage/mini-lms/v2/mini-lms/resources/views/layouts/app.blade.php ENDPATH**/ ?>